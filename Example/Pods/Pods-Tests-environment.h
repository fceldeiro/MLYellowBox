...
// MLYellowBox
#define COCOAPODS_POD_AVAILABLE_MLYellowBox
#define COCOAPODS_VERSION_MAJOR_MLYellowBox 0
#define COCOAPODS_VERSION_MINOR_MLYellowBox 1
#define COCOAPODS_VERSION_PATCH_MLYellowBox 0
